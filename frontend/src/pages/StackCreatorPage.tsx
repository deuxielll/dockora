    ...
    <div className="flex-1 flex flex-col">
      <div className="flex-1 flex flex-col lg:flex-row gap-8"> {/* New wrapper for the two main content areas */}
        ...
        <div className={`p-6 rounded-xl ${panelClasses} flex-1 flex flex-col`}>
          <fieldset disabled={deploymentId !== null} className="flex-shrink-0"> {/* Stack Name is fixed */}
            <div>
          ...
          <div className="flex justify-between items-center flex-shrink-0 mt-8"> {/* Tab and action buttons are fixed */}
          ...
          <fieldset disabled={deploymentId !== null} className="flex-1 flex flex-col mt-8"> {/* This fieldset now manages its children's height */}
            {editorMode === 'visual' ? (
              <div className="flex-1 flex flex-col"> {/* This div needs to manage its children's height */}
                <div className="flex-shrink-0"> {/* Header for services */}
                  <h3 className="text-lg font-semibold mb-4 text-gray-200">Services</h3>
                </div>
                <div className="flex-grow overflow-y-auto space-y-6 pr-2 no-scrollbar"> {/* THIS IS THE NEW SCROLLABLE AREA */}
                ...
                <div className="mt-8 flex-shrink-0"> {/* Networks section, fixed at bottom */}
