...
import DownloadClientWidget from '../components/widgets/DownloadClientWidget'; // New: Import DownloadClientWidget
...
export const WIDGETS_CONFIG = { // Exported for use in WidgetGrid and PopoutWidgetPage
  ...
  downloadClient: { component: DownloadClientWidget, title: 'Downloads', defaultVisible: true, defaultLayout: { h: 4, minH: 3, minW: 1 } }, // New: Download Client Widget
};
